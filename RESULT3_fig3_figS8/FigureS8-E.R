##Script to Supplementary fig8-E.
...
rongyuan_reads_forzhexian <- read.csv("~/cooperation/202409zhaofengxiang/data/fig3_S8_reads.csv")
rongyuan_contig_length <- read.csv("~/cooperation/202409zhaofengxiang/data/fig3_S8_length.csv")
viruse_IMG_contig_anno_chayijun <- read.csv("~/cooperation/202409zhaofengxiang/data/fig3_S8_anno.csv")
