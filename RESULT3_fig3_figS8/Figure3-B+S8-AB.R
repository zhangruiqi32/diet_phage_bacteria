##Script to Figure 3-B and Supplementary fig8-AB.
...
############################## Data loading ##############################
reads_number2s <- read.csv("/home/wanglab/students/zhangruiqi/cooperation/202409zhaofengxiang/data/fig3B_S8AB_readnum.csv")
contigs_phacts <- read.csv("/home/wanglab/students/zhangruiqi/cooperation/202409zhaofengxiang/data/fig3B_S8AB_lifestyle.csv")
cluster <- read.csv("/home/wanglab/students/zhangruiqi/cooperation/202409zhaofengxiang/data/fig3B_S8AB_cluster.csv")
clstr_name_change <- read.csv("/home/wanglab/students/zhangruiqi/cooperation/202409zhaofengxiang/data/fig3B_S8AB_name.csv")
Cluster_Linage <- read.csv("/home/wanglab/students/zhangruiqi/cooperation/202409zhaofengxiang/data/fig3B_S8AB_linage.csv")
