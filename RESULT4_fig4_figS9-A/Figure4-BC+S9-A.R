##Script to Figure 4-BC and Supplementary fig9-A.
...
############################## Data loading ##############################
HGT_reads <- read.csv("~/cooperation/202409zhaofengxiang/data/fig4BC_S9A_reads.csv")
HGT_contig_length <- read.csv("~/cooperation/202409zhaofengxiang/data/fig4BC_S9A_length.csv")
...
############################## [FigS9-A] Processing and Painting #####################################
